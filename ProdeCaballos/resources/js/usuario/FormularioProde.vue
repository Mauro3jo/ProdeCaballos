...
<!--<ol v-else class="prode-reglas-list">
  ...
  <li><span class="prode-reglas-num">12.</span> El valor del Prode es de $10.000.</li>
  <li><span class="prode-reglas-num">13.</span> Si aciertas en 10 carreras, ganás el Prode que equivale a $1.000.000.</li>
  <li><span class="prode-reglas-num">14.</span> Si NO aciertas a las 10 carreras, pero tenés más aciertos que otros jugadores, ganás $300.000.</li>
  <li><span class="prode-reglas-num">15.</span> Si hay 2 o más ganadores, el premio se reparte de manera proporcional.</li>
  <li><span class="prode-reglas-num">16.</span> Si hay 10 aciertos, el "sale o sale" de $300.000 no se entrega.</li>
</ol>-->
